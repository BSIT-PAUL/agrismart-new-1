...
<?= $this->section('content')?>
    <div class="login-box box-shadow border-radius-10">
        ...
        <form action="<?= route_to('send-password-reset-link') ?>" method="POST">
            <?= csrf_field(); ?>
            ...
            <div class="row align-items-center">
                <div class="col-5">
                    <div class="input-group mb-0 btn-form">
                        <input class="btn btn-lg btn-block btn-success" type="submit" value="Submit"></input>
                    </div>
                </div>
                <div class="col-2">
                ...
                <div class="col-5">
                    <div class="input-group mb-0 btn-form">
                        <a class="btn btn-outline-success btn-lg btn-block" href="<?= route_to('admin.login.form') ?>">Login</a>
                    </div>
                </div>
            </div>
        </form>
